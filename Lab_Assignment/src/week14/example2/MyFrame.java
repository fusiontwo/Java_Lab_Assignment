...
public class MyFrame extends JFrame implements KeyListener{
	...
	public MyFrame() {
		...
		this.panel2.setFocusable(true);
		this.panel2.requestFocus();
		this.panel2.addKeyListener(this);
	}
...
//		this.charIcon.setLocation(xpos, ypos);
	...
	public void keyPressed(KeyEvent e) {
		// TODO Auto-generated method stub
		switch(e.getKeyCode()) {
		case KeyEvent.VK_LEFT -> {xpos-=10;}
		case KeyEvent.VK_RIGHT -> {xpos+=10;}
		case KeyEvent.VK_UP -> {ypos-=10;}
		case KeyEvent.VK_DOWN -> {ypos+=10;}
		}
		this.charIcon.setLocation(xpos, ypos);
	}
