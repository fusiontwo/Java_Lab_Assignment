...
//		this.charIcon.setLocation(xpos, ypos);
		this.charIcon.setBounds(xpos, ypos, img.getIconWidth(), img.getIconHeight());
	...
	private void initPanel3() {
		// TODO Auto-generated method stub
		this.panel1 = new JPanel(new GridLayout(4,1,10,10));
		...
		btn2.addActionListener(e->{  // btn1에 대한 리스너 1
		...
		btn3.addActionListener(e->{  // btn1에 대한 리스너 1
			if(xpos>=10) {
				xpos -= 10;
				charIcon.setLocation(xpos, ypos);
			}
		...
		btn4.addActionListener(e->{
			if(xpos <= panel2.getWidth() - img.getIconWidth() - 10) {  // 화면 크기를 늘리고 줄여도 적용되도록!
				xpos += 10;
				charIcon.setLocation(xpos, ypos);
			}
		});
